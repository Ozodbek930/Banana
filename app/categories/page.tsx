...
export default function Dashboard() {
  ...
  const fetchCounts = async () => {
    ...
    if (categoryError)
      console.error(
        "Kategoriya sonini olishda xatolik:",
        categoryError.message
      );
    if (orderError)
      console.error("Buyurtmalar sonini olishda xatolik:", orderError.message);
    ...
    return (
      <div className="container py-4">
        <h2 className="text-center mb-4">
          Dashboard sahifasiga kirish uchun parolni kiriting
        </h2>
        <form
        ...
        <div className="grid grid-cols-4 gap-4 mt-4">
          <div className="bg-white p-4 rounded shadow">
            ...
            <h3 className="text-2xl font-bold">
              {loading ? "Loading..." : `${categoryCount}x`}
            </h3>
          </div>
          <div className="bg-white p-4 rounded shadow">
            <p className="text-gray-600">Products</p>
            <h3 className="text-2xl font-bold">
              {loading ? "Loading..." : `${orderCount}x`}
            </h3>
          </div>
          <div className="bg-white p-4 rounded shadow">
