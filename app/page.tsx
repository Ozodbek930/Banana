      ...
      <footer className="bg-gray-100 text-gray-700 text-sm mt-12">
        <div className="container mx-auto p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <img src="/Group 18.png" alt="Plant Renovation" className="mx-auto" />
            ...
            <div className="text-center">
              <img src="/Group 19.png" alt="Watering Garden" className="mx-auto" />
          ...
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-2">
                <img src="/image 16.png" alt="American Express" className="w-100" />
              </div>
            </div>
          </div>
